...
public class LoginView extends JFrame{
    ...
    public void initUI() {
        ...
        JLabel signUpLabel = new JLabel("<html>Don't have account? <font color='#3674D0'>Sign Up.</font></html>");
        JLabel forgotPasswordLabel = new JLabel("Forgot your Password?");
        loginButton.setPreferredSize(new Dimension(150,50));
        spLabel.setFont(new Font("Nunito", Font.BOLD, 68));
        ...
        welcomeLabel.setFont(new Font("Nunito", Font.PLAIN, 15));
        loginHeadingLabel.setForeground(themeColor);
        loginHeadingLabel.setFont(new Font("Nunito", Font.BOLD, 25));
        emailInputLabel.setFont(new Font("Nunito", Font.PLAIN, 16));
        passwordInputLabel.setFont(new Font("Nunito", Font.PLAIN, 16));
