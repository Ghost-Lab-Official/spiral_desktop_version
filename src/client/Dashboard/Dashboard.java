...
public class Dashboard {
    ...
    JLabel DashboardLabel,
            ...
            billing2Label,
            TopRatedLabelTitle,
            recentRegisterdSpotsLabel,
            bestRatedSpotLabel;
    JLabel dashboardIconLabel,
            usersIconLabel,
            billingsIconLabel,
            locationsIconLabel,
            spotsIconLabel,
    ...
    public void dashboardInit() throws Exception {
        try {
...
//                System.out.println(SpotsReport.getSpot_name());
            ...
            chart=ChartFactory.createLineChart("Users of the system", "year", "Number of users", dataset, PlotOrientation.VERTICAL,
                    true, false, false);
