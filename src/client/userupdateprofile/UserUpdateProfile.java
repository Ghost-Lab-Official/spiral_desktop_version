...
public class UserUpdateProfile {
    ...
    public UserUpdateProfile() throws IOException {
        ...
        img1 = ImageIO.read(new File("src/client/images/dashboard1.png"));
        ...
        img2 = ImageIO.read(new File("src/client/images/userBlack.png"));
        ...
        img5 = ImageIO.read(new File("src/client/images/notifications.png"));
        ...
        img6 = ImageIO.read(new File("src/client/images/settingsBlack.png"));
        ...
        img7 = ImageIO.read(new File("src/client/images/logoutBlue.png"));
    ...
    public static void main(String args[]) throws IOException{
        UserUpdateProfile profile = new UserUpdateProfile();
    }
}