...
public class SpotCommentController {
  ...
  public List<Object> mainMethod(RequestBody requestBody) throws Exception {
    ...
    switch (action) {
      case "register":
        ResponseStatus registeredStatus = new SpotCommentActions()
        .insertComment((Comment) requestBody.getObject());
        usersObject.add((Object) registeredStatus);
        return usersObject;
      case "update":
        ResponseStatus updatedStatus = new SpotCommentActions()
        .updateComment((Comment) requestBody.getObject());
        usersObject.add((Object) updatedStatus);
        return usersObject;
      case "reply-comment":
        ResponseStatus replyStatus = new SpotCommentActions()
        .makeCommentReply((Comment) requestBody.getObject());
        usersObject.add((Object) replyStatus);
        return usersObject;
      case "update-status":
        ResponseStatus updatedCommentStatus = new SpotCommentActions()
        .updateCommentStatus((Comment) requestBody.getObject());
        usersObject.add((Object) updatedCommentStatus);

        return usersObject;
      case "getComments":
        List<Comment> spotCommentList = new SpotCommentActions()
        .GetComments((Integer) requestBody.getObject());
      ...
      case "getCommentReplies":
        List<Comment> spotCommentRepliesList = new SpotCommentActions()
        .GetCommentReplies((String) requestBody.getObject());
